...
public class SpreadMethodTargetVisualizerOnCell : MonoBehaviour
{
    ...
    public void PlayVisual(SpreadMethodTargetVisualizationPreset preset)
    {
    ...
    private IEnumerator PlayRoutine(SpreadMethodTargetVisualizationPreset preset)
    {
